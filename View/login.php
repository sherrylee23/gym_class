            ...
            <div class="card login-card">
                ...
                <div class="p-4 p-md-5">
                    <div class="text-center mb-4">
                        <h2 class="fw-bold purple-text">Welcome Back</h2>
                        <p class="text-muted small">Let's crush it this week!</p>
                    </div>
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" class="btn btn-purple w-100 py-2 fw-bold mb-3">LOG IN</button>
                    </form>

                    <div class="text-center">
                        <p class="small text-muted mb-0">New member? <a href="register.php" class="purple-text fw-bold text-decoration-none">Create Account</a></p>
                    </div>
                </div>
            </div>
        </div>
