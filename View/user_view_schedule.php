...
<head>
    ...
    <style>
        ...
        .filter-section {
            ...
            margin-top: -30px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); border: none;
        }
        .class-card {
        ...
        .btn-purple {
            background: #6f42c1; color: white; border-radius: 10px;
            font-weight: 600; padding: 10px 20px; transition: 0.3s;
        }
        .btn-purple:hover { background: #59359a; color: white; }
        .info-item { font-size: 0.9rem; color: #6c757d; margin-bottom: 8px; }
        .info-item i { color: #6f42c1; margin-right: 8px; width: 20px; }
        .class-name { color: #333; font-weight: 700; margin-bottom: 15px; }
        .text-purple { color: #6f42c1; }
        .slot-badge { font-size: 0.75rem; padding: 4px 8px; border-radius: 6px; }
    </style>
</head>
<body>
